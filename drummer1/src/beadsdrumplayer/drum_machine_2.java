...
public class drum_machine_2
{
	...
	public float[] mNote1 = new float[100];
	...
	public void setup()
	{
		...
		AudioContext ac = new AudioContext();
				...
				Newbuffers mlr = new Newbuffers(99);
				...
				snareTone = new WavePlayer(ac,300f, Buffer.SAW);
				snareTone3.addInput(snareTone);
				snareFilter = new BiquadFilter(ac, BiquadFilter.BP_SKIRT,2000f, 1f);
				snareFilter2 = new BiquadFilter(ac, BiquadFilter.BP_PEAK,150f, 25f);
				snareFilter.addInput(snareNoise);
				snareFilter.addInput(snareTone3);
				...
				snareNoise1 = new WavePlayer(ac,200f, Buffer.NOISE);
				snareFilter = new BiquadFilter(ac, BiquadFilter.BP_SKIRT,200.0f, 1f);
				snareFilter2 = new BiquadFilter(ac, BiquadFilter.BP_PEAK, 50.0f, 1f);
				snareFilter.addInput(snareNoise1);
				...
				revdrum1.setSize(0.001f);
				revdrum1.setLateReverbLevel(1f);
	...
	public void keyDown(int midiPitch)
	{
		...
		if( midiPitch == 4 )
		{
			...
			// decay segment
			snareGainEnvelope.addSegment(50f, 50f);
			// release segment
	...
	public void keyUp(int midiPitch)
	{
	 ...
	 ActionListener taskPerformer = new ActionListener() {
	        public void actionPerformed(ActionEvent evt) {
	        	...
	        	m++;
	        if (mTime[m+1]==0){m=2;} //Resets the numbers its basically taking the value of the empty array number.  
	        }
	    };
