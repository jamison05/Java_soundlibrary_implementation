...
public class drum_machine_2
{
	...
	public void setup()
	{
		...
		AudioContext ac = new AudioContext();
				...
				snareLP.addInput(snareFilter);
				snareGain1.addInput(snareLP);
