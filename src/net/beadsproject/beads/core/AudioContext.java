...
public class AudioContext {
	...
	public final ConcurrentLinkedQueue<Bead> beforeFrameQueue = new ConcurrentLinkedQueue<Bead>();
	public final ConcurrentLinkedQueue<Bead> afterFrameQueue = new ConcurrentLinkedQueue<Bead>();
	public final ConcurrentLinkedQueue<Bead> beforeEveryFrameList = new ConcurrentLinkedQueue<Bead>();
	public final ConcurrentLinkedQueue<Bead> afterEveryFrameList = new ConcurrentLinkedQueue<Bead>();
	 ...
	 */
	public void sendBeforeFrameMessages() {
		Bead target;
	 ...
	 */
	public void sendAfterFrameMessages() {
		Bead target;
