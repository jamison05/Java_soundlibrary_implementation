...
public class drum_machine_2
{
	...
	public void setup()
	{
		...
		AudioContext ac = new AudioContext();
				...
				snareTone = new WavePlayer(ac,500f, Buffer.SAW);
				snareTone3.addInput(snareTone);
				snareFilter = new BiquadFilter(ac, BiquadFilter.BP_SKIRT,2000f, 1f);
				snareFilter2 = new BiquadFilter(ac, BiquadFilter.BP_PEAK,300f, 25f);
				...
				revdrum1.setSize(0.04f);
				revdrum1.setLateReverbLevel(0.2f);
